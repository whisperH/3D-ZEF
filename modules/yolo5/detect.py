...
def run(weights='yolov5s.pt',  # model.pt path(s)
    ...
    if not os.path.exists(project):
        os.makedirs(project)
    txt_path = str(f"{project}/{Video_name.replace('.avi', '.csv').replace('.mp4', '.csv').replace('.MOV', '.csv')}")
    f = open(txt_path, 'w+')
    f.write(
...
def parse_opt():
    ...
    parser.add_argument('--config_path', type=str,
                        ...
                        default='E:\\data\\OCU_ZeF2',
                        help='config path'
                        )
    parser.add_argument('--region_name', type=str, default='1_WideType', help='config path')

    parser.add_argument('--source', type=str,
                        default='E:\\data\\OCU_ZeF2\\cut_video/20211031_ch12.mp4',
                        help='file/dir/URL/glob, 0 for webcam'
                        )
    parser.add_argument('--project',
                        default='E:\\data\\OCU_ZeF2\\processed\\1_WideType',
