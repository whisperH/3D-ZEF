...
if __name__ == '__main__':
    ...
    parser.add_argument("--exp_floder", default="E:\\data\\3D_pre\\D8_T4", type=str, help="video shear dirpath")
    parser.add_argument("--save_path", default="E:\\data\\3D_pre\\D8_T4\\cut_video", type=str, help="video save path")
    parser.add_argument("--video_name",
                        # default="/home/data/HJZ/zef/0918-0919fish",
                        default="ch12_20211023203342.mp4",
                        type=str, help="video shear dirpath"
                        )
    parser.add_argument("--start_time",
                        # default="/home/data/HJZ/zef/0918-0919fish",
                        default="2021_10_24_01_55_59",
    ...
    while True:
        ...
        # ====================== using moviepy ==========================#
        time_pos = load_time_pos_setting(config_folder, camNO)
        frame_time_str = getImgTime(frame, time_pos, start_time, video_name, verbose=True, reader=reader)
